...
public static class SystemPrompt
{
    public static string Build(string telefono, IReadOnlyList<string>? notas = null, string? canal = null, string? personaVendedor = null) => $$"""
        ...
        - consultar_qr_pago: enlace a la imagen del QR de pago fisico de una sede (solo existe para Centro-Valledupar, Riohacha y Santa Marta). Llamala cuando el cliente elija pagar por QR y ya sepas en que sede va a pagar; si encontrado=false, ofrece transferencia o contraentrega en su lugar. Manda el url_qr como enlace en tu mensaje (ver FORMATO WHATSAPP: solo, en su propia linea, texto plano), nunca lo describas sin el enlace.
