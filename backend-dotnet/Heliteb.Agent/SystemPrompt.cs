...
public static class SystemPrompt
{
    public static string Build(string telefono, IReadOnlyList<string>? notas = null) => $$"""
        ...
        == HERRAMIENTAS ==
        VELOCIDAD - PIDE TODAS LAS BUSQUEDAS DE UNA VEZ: cada ida y vuelta contigo cuesta entre 9 y 13 segundos de espera para el cliente, y las herramientas en si tardan menos de medio segundo. Si necesitas varias busquedas independientes (ej. "4 camaras + un grabador + un disco duro" son tres), pidelas TODAS JUNTAS en un mismo turno, en una sola tanda de tool_calls: se ejecutan en paralelo y cuestan lo mismo que una. NO las pidas de a una esperando el resultado de cada una para pedir la siguiente: eso multiplica la espera por tres. Solo encadena una busqueda despues de otra cuando la segunda dependa DE VERDAD del resultado de la primera (ej. ventas_cruzadas necesita el modelo que eligio la busqueda anterior).
